...
<div class="min-h-screen bg-[#f8f8fc]">
  ...
  <div class="pt-20" style="background:linear-gradient(135deg,#00002a 0%,#000060 50%,#000080 100%)">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
      ...
      <p class="mt-3 text-white/50 text-lg max-w-2xl">
        CNA International Enterprises Inc. stands behind every product we sell.
      </p>
    </div>
  </div>
  ...
  <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
    <div class="prose-cna">
      ...
      <table>
        <thead>
          <tr><th>Product Type</th><th>Warranty Period</th></tr>
        </thead>
        <tbody>
          <tr><td>LED Products</td><td>2–5 years from date of sale</td></tr>
          <tr><td>LED Exit Signs</td><td>10 years from date of sale</td></tr>
          <tr><td>CFL Products</td><td>1 year from date of sale</td></tr>
        </tbody>
      </table>

      <h3>For Distributors &amp; Retailers</h3>
      <p>
        CNA may, at its discretion, replace defective items or credit your account at the current distributor pricing or original invoice
        amount — whichever is lower. Warranty coverage <strong>excludes</strong> freight, removal, re-installation, labour, or equipment costs.
      </p>
      <p>
